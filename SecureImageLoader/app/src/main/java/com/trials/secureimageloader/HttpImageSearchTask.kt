...
abstract class HttpImageSearchTask : AsyncTask<String, Void, Any?>() {
    ...
    public override  fun doInBackground(vararg params: String?): Any? {
        ...
        try {
            ...
            image_url = JSONObject(json).getJSONObject("responseData")
    ...
    companion object {
        private val TAG = HttpImageSearchTask::class.java.simpleName
    }
